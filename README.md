...
You then need to modify the src/manifest.json and replace starter-kit by WifiManager
...
ln -s `pwd`/dist ~/.local/share/cockpit/WifiManager
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/WifiManager
